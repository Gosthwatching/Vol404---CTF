// Defini les routes HTTP liees aux billets et au scan QR.
...
router.get('/manifests', billetController.getManifests); // accessible sans auth â€” exploration des manifests
router.get('/passengers', billetController.getAllPassengers); // accessible sans auth â€” indice CTF
